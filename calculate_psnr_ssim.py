...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='../lpr-rsr-ext/clear_PSrec/HR/test', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='./results/Only_PLoss_test/visualization/LP', help='Path to restored images')
    parser.add_argument('--crop_border', type=int, default=2, help='Crop border for each side')
    parser.add_argument('--suffix', type=str, default='_SR', help='Suffix for restored images')
    parser.add_argument(
        '--test_y_channel',
        action='store_true',
